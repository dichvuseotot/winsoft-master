...
const SAMPLE_PATIENTS = [
  ...
  {
    soDinhDanh: "079201003456",
    hoTen: "Phạm Thị Dung",
    gioiTinh: "Nữ",
    ngaySinh: "2001-05-30",
    ngheNghiep: "06 — Học sinh/Sinh viên",
  ...
  {
    soDinhDanh: "079201007890",
    hoTen: "Võ Minh Đức",
    gioiTinh: "Nam",
    ngaySinh: "1965-09-18",
    ngheNghiep: "07 — Hưu trí",
  ...
  {
    soDinhDanh: "079201002468",
    hoTen: "Huỳnh Thị Lan",
    gioiTinh: "Nữ",
    ngaySinh: "1988-12-10",
    ngheNghiep: "03 — Thương nhân",
...
const GD_ICD10_OPTIONS = [
  "A000 - Bệnh tả do vi khuẩn Vibrio",
  "A00 - Bệnh tả",
  "A00.0 - Bệnh tả do vi khuẩn Vibrio cholerae 01, típ sinh học cholerae",
  "A00.1 - Bệnh tả do Vibrio cholerae 01, típ sinh học eltor",
  "A00.9 - Bệnh tả, không xác định",
  "A01 - Bệnh thương hàn và/hoặc bệnh phó thương hàn",
  "A01.0 - Bệnh thương hàn",
  ...
  "A02.0 - Viêm dạ dày ruột Salmonella",
  "A15 - Lao hô hấp",
  "A16 - Lao hô hấp, không xác nhận vi khuẩn học",
  "B15 - Viêm gan siêu vi A cấp",
  "B16 - Viêm gan siêu vi B cấp",
  "B18 - Viêm gan siêu vi mạn tính",
  "B24 - Bệnh do HIV, không xác định",
  "C00-C97 - Khối u ác tính",
  "C34 - Ung thư phổi",
  "C50 - Ung thư vú",
  ...
  "Z82.0 - Tiền sử gia đình về động kinh",
  "Z82.1 - Tiền sử gia đình về mù",
  "Z82.3 - Tiền sử gia đình về đột quỵ",
  "Z82.4 - Tiền sử gia đình về bệnh tim thiếu máu",
  "Z82.5 - Tiền sử gia đình về bệnh tăng huyết áp",
  "Z82.6 - Tiền sử gia đình về ung thư",
